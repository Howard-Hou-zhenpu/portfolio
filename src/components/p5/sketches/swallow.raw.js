...
// -- 速度限制 --
const MAX_SPEED = {{MAX_SPEED|3.2}};
const MIN_SPEED = {{MIN_SPEED|1.4}};
const MAX_FORCE = {{MAX_FORCE|0.09}};
...
// 燕子各飞各的、偶尔擦身,不会挤成一团。
const WEIGHT_ALIGN    = {{WEIGHT_ALIGN|0.25}};
const WEIGHT_COHERE   = {{WEIGHT_COHERE|0.0}};
const WEIGHT_SEPARATE = {{WEIGHT_SEPARATE|1.1}};

// -- 光标斥力 (惊扰) --
const CURSOR_RADIUS = {{CURSOR_RADIUS|150}};
const CURSOR_FORCE  = {{CURSOR_FORCE|1.8}};
