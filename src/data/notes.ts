...
export const notes: Note[] = [
  {
    ...
    summaryZh:
      "好的 AI 产品不替用户做决定，而是帮助用户做出更好的决定。AI 的角色是呈现规律、挑战假设，并提出更好的问题。",
    reflectionZh:
  ...
  },
  {
    ...
    summaryZh:
      "Vibe Coding 不只是让开发变快，而是降低了想法到落地之间的门槛。借助 Claude Code，我从“如果有这个就好了”走到“它已经上线”只用了几周。这让我这种非传统技术背景的人，也能更直接地参与产品搭建。",
    reflectionZh:
  ...
  },
  {
    ...
    titleZh: "AI 内容生产不只是快。",
    summaryZh:
      "AI 内容工作流不只是产得更快，更重要的是产得更准。本地化和信任建设仍然依赖人的判断。AI 负责加速，人定义策略。",
    reflectionZh:
  ...
  },
  {
    ...
    summaryZh:
      "品牌策略教会我理解人和市场，AI 产品搭建教会我快速发布与迭代。两者结合后，我既能判断该做什么，也能把它真正做出来。",
    reflectionZh:
